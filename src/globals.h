...
enum PLAYERSTATES
{
	...
	STATE_SLIDING = 0x08,
	//STATE_JUMPING = 0x10,
	//STATE_INPLATFORM = 0x20,
	STATE_ONMACHINERY = 0x40,
	//STATE_SHOOTING = 0x80,
	STATE_SHOTLOCKED = 0x100,
	STATE_CHARGING = 0x200,
	STATE_LOOKINGUP = 0x400,
	//STATE_CRAWLING = 0x800,
	//STATE_FALLENOVER = 0x1000,
	STATE_DUCKING = 0x2000
};
